...
const landing = props => (
  <div className={classes.LandingPage}>
    <div className={classes.Header}>
      ...
      <div className={['card', classes.TextBox].join(' ')}>
        ...
        <p style={{ fontSize: '1.4rem', textAlign: 'left' }}>
          ...
          <br />
          <em>
            Ingredient parser service is temporarily offline. Recipe creation
            and import will not work. I hope to restore this functionality as
    ...
    <div>
      <div
        style={{ background: '-webkit-linear-gradient(top, #80DEEA, #FFF)' }}
      >
        <section
          ...
          <Card className={classes.MarketingCard}>
            ...
            <div className={classes.Text}>
              ...
              <p style={{ fontSize: '2.4rem', fontWeight: 'bold' }}>
                Omnivorous helps you gather recipes and organize them, so your
                next meal is only a few clicks away.
              </p>
            </div>
          </Card>
        </section>
          ...
          <Card className={classes.MarketingCard}>
            <div className={classes.Text}>
              ...
              <p style={{ fontSize: '1.8rem' }}>
                Omnivorous lets you easily build and organize shopping lists.
                Add recipe ingredients to your shopping list with one click, and
                drag and drop to organize them.
              </p>
            </div>
            <div className={classes.Graphic}>
              <img
        ...
        <section className={classes.Description}>
          <Card className={classes.MarketingCard}>
            <div className={classes.Graphic}>Coming Soon!</div>
            <div className={classes.Text}>
              <h2 className={classes.TextHeader}>Plan Your Week</h2>
              <p style={{ fontSize: '1.8rem' }}>
                Drag and drop recipes onto your weekly meal plan. Build a
                shopping list from your meal plan in seconds!
              </p>
            </div>
          </Card>
        </section>
      ...
      <footer>
        An app by Tucker McKinney. Last updated:{' '}
